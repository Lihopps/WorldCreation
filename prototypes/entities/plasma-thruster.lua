...
data.raw.fluid["fusion-plasma"].fuel_value = "150kJ"
...
data:extend({
    ...
    },
    {
        ...
        max_health = 300,
        minable = { mining_time = 0.1, result = "lihop-plasma-thruster" },
        ...
        min_performance = { fluid_volume = 0.05, fluid_usage = 0.1, effectivity = 0.2 },
        max_performance = { fluid_volume = 0.95, fluid_usage = 2, effectivity = 1.1 },
        fuel_fluid_box =
        {
            ...
            pipe_connections =
            {
                { flow_direction = "input-output", direction = defines.direction.west, position = { -1.5, -2 }, enable_working_visualisations = { "pipe-4" }, connection_category = "fusion-plasma" },
                { flow_direction = "input-output", direction = defines.direction.east, position = { 1.5, 0 }, enable_working_visualisations = { "pipe-2" }, connection_category = "fusion-plasma" },
            }
        },
        oxidizer_fluid_box =
        {
            ...
            {
                {
                    sound =
                    {
                        ...
                        "__space-age__/sound/entity/platform-thruster/thruster-mechanic-stop", 5, 0.5),
                ...
                },
                {
                    ...
                    {
                        variations = sound_variations(
                        "__space-age__/sound/entity/platform-thruster/thruster-mechanic-move", 5, 0.3),
                        advanced_volume_control =
                        {
                            fades = { fade_in = { curve_type = "S-curve", from = { control = 0.5, volume_percentage = 0.0 }, to = { 3, 100.0 } } },
                        }
